...
function Button({buttonClass, onClick, children, ariaLabel }) {
    return (
...
export default function SearchButton({ onClick, ariaLabel }) {
    return (
        <Button buttonClass="btn-search" onClick={onClick} ariaLabel={ariaLabel}>
